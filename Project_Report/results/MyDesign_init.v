...
module MyDesign ( dut_run, reset_b, clk, dut_busy, dut_sram_read_address, 
  ...
  wire   \in4[8] , N42, N593, N595, N597, N599, n129, n130, n131, n132, n133,
  ...
  DFF_X1 \state_reg[1]  ( .D(N42), .CK(clk), .Q(state[1]), .QN(n487) );
  DFF_X1 \weight_reg[8]  ( .D(n172), .CK(clk), .Q(weight[8]), .QN(n461) );
  DFF_X1 \in1_reg[8]  ( .D(n147), .CK(clk), .Q(in1[8]), .QN(n492) );
  DFF_X1 \in1_reg[7]  ( .D(n146), .CK(clk), .QN(n490) );
  DFF_X1 \in1_reg[6]  ( .D(n145), .CK(clk), .QN(n485) );
  DFF_X1 \in1_reg[5]  ( .D(n144), .CK(clk), .QN(n480) );
  DFF_X1 \in1_reg[4]  ( .D(n143), .CK(clk), .QN(n481) );
  DFF_X1 \in1_reg[3]  ( .D(n142), .CK(clk), .QN(n469) );
  DFF_X1 \in1_reg[2]  ( .D(n141), .CK(clk), .QN(n470) );
  DFF_X1 \in1_reg[1]  ( .D(n140), .CK(clk), .QN(n464) );
  DFF_X1 \in2_reg[8]  ( .D(n138), .CK(clk), .Q(in2[8]), .QN(n493) );
  DFF_X1 \in2_reg[7]  ( .D(n137), .CK(clk), .QN(n491) );
  DFF_X1 \in2_reg[5]  ( .D(n135), .CK(clk), .QN(n475) );
  DFF_X1 \in2_reg[4]  ( .D(n134), .CK(clk), .QN(n482) );
  DFF_X1 \in2_reg[3]  ( .D(n133), .CK(clk), .QN(n471) );
  DFF_X1 \in2_reg[2]  ( .D(n132), .CK(clk), .QN(n472) );
  DFF_X1 \in2_reg[1]  ( .D(n131), .CK(clk), .QN(n465) );
  DFF_X1 \in2_reg[0]  ( .D(n130), .CK(clk), .QN(n466) );
  DFF_X1 \in3_reg[8]  ( .D(n129), .CK(clk), .Q(in3[8]), .QN(n494) );
  DFF_X1 \in3_reg[7]  ( .D(n197), .CK(clk), .QN(n488) );
  DFF_X1 \in3_reg[6]  ( .D(n196), .CK(clk), .QN(n484) );
  DFF_X1 \in3_reg[5]  ( .D(n195), .CK(clk), .QN(n479) );
  DFF_X1 \in3_reg[4]  ( .D(n194), .CK(clk), .QN(n478) );
  DFF_X1 \in3_reg[3]  ( .D(n193), .CK(clk), .QN(n468) );
  DFF_X1 \in3_reg[1]  ( .D(n191), .CK(clk), .QN(n463) );
  DFF_X1 \in3_reg[0]  ( .D(n190), .CK(clk), .QN(n462) );
  DFF_X1 \in4_reg[8]  ( .D(n189), .CK(clk), .Q(\in4[8] ), .QN(n495) );
  DFF_X1 \in4_reg[7]  ( .D(n188), .CK(clk), .QN(n489) );
  DFF_X1 \in4_reg[6]  ( .D(n187), .CK(clk), .QN(n483) );
  DFF_X1 \in4_reg[5]  ( .D(n186), .CK(clk), .QN(n486) );
  DFF_X1 \in4_reg[4]  ( .D(n185), .CK(clk), .QN(n476) );
  DFF_X1 \in4_reg[3]  ( .D(n184), .CK(clk), .QN(n477) );
  DFF_X1 \in4_reg[2]  ( .D(n183), .CK(clk), .QN(n467) );
  DFF_X1 \in4_reg[1]  ( .D(n182), .CK(clk), .QN(n473) );
  DFF_X1 \in4_reg[0]  ( .D(n181), .CK(clk), .QN(n474) );
  DFF_X1 \plh1_reg[3]  ( .D(n180), .CK(clk), .Q(N599), .QN(n502) );
  DFF_X1 \plh2_reg[3]  ( .D(n178), .CK(clk), .Q(N597), .QN(n504) );
  DFF_X1 \plh3_reg[3]  ( .D(n179), .CK(clk), .Q(N595), .QN(n503) );
  DFF_X1 \plh4_reg[3]  ( .D(n199), .CK(clk), .Q(N593), .QN(n501) );
  DFF_X1 \state_reg[0]  ( .D(n505), .CK(clk), .QN(state[0]) );
  DFF_X1 \in3_reg[2]  ( .D(n506), .CK(clk), .QN(in3[2]) );
  DFF_X1 \in2_reg[6]  ( .D(n533), .CK(clk), .QN(in2[6]) );
  DFF_X1 \in1_reg[0]  ( .D(n532), .CK(clk), .QN(in1[0]) );
  DFF_X1 \weight_reg[7]  ( .D(n508), .CK(clk), .QN(weight[7]) );
  DFF_X1 \weight_reg[6]  ( .D(n509), .CK(clk), .QN(weight[6]) );
  DFF_X1 \weight_reg[5]  ( .D(n510), .CK(clk), .QN(weight[5]) );
  DFF_X1 \weight_reg[4]  ( .D(n511), .CK(clk), .QN(weight[4]) );
  DFF_X1 \weight_reg[3]  ( .D(n512), .CK(clk), .QN(weight[3]) );
  DFF_X1 \weight_reg[2]  ( .D(n513), .CK(clk), .QN(weight[2]) );
  DFF_X1 \weight_reg[1]  ( .D(n514), .CK(clk), .QN(weight[1]) );
  DFF_X1 \weight_reg[0]  ( .D(n515), .CK(clk), .QN(weight[0]) );
  DFF_X1 \in_reg[15]  ( .D(n516), .CK(clk), .QN(in[15]) );
  DFF_X1 \in_reg[14]  ( .D(n517), .CK(clk), .QN(in[14]) );
  DFF_X1 \in_reg[13]  ( .D(n518), .CK(clk), .QN(in[13]) );
  DFF_X1 \in_reg[12]  ( .D(n519), .CK(clk), .QN(in[12]) );
  DFF_X1 \in_reg[11]  ( .D(n520), .CK(clk), .QN(in[11]) );
  DFF_X1 \in_reg[10]  ( .D(n521), .CK(clk), .QN(in[10]) );
  DFF_X1 \in_reg[9]  ( .D(n522), .CK(clk), .QN(in[9]) );
  DFF_X1 \in_reg[8]  ( .D(n523), .CK(clk), .QN(in[8]) );
  DFF_X1 \in_reg[7]  ( .D(n524), .CK(clk), .QN(in[7]) );
  DFF_X1 \in_reg[6]  ( .D(n525), .CK(clk), .QN(in[6]) );
  DFF_X1 \in_reg[5]  ( .D(n526), .CK(clk), .QN(in[5]) );
  DFF_X1 \in_reg[4]  ( .D(n527), .CK(clk), .QN(in[4]) );
  DFF_X1 \in_reg[3]  ( .D(n528), .CK(clk), .QN(in[3]) );
  DFF_X1 \in_reg[2]  ( .D(n529), .CK(clk), .QN(in[2]) );
  DFF_X1 \in_reg[1]  ( .D(n530), .CK(clk), .QN(in[1]) );
  DFF_X1 \in_reg[0]  ( .D(n531), .CK(clk), .QN(in[0]) );
  DFF_X2 buzz_reg ( .D(n507), .CK(clk), .QN(dut_busy) );
  DFF_X2 \feature_map_reg[3]  ( .D(n198), .CK(clk), .Q(dut_sram_write_data[3]), 
        .QN(n496) );
  DFF_X2 \feature_map_reg[2]  ( .D(n177), .CK(clk), .Q(dut_sram_write_data[2]), 
        .QN(n497) );
  DFF_X2 \feature_map_reg[1]  ( .D(n174), .CK(clk), .Q(dut_sram_write_data[1]), 
        .QN(n499) );
  DFF_X2 \feature_map_reg[0]  ( .D(n175), .CK(clk), .Q(dut_sram_write_data[0]), 
        .QN(n498) );
  ...
  AOI22_X1 U333 ( .A1(\in4[8] ), .A2(n452), .B1(in[15]), .B2(n451), .ZN(n273)
         );
  ...
  AOI22_X1 U368 ( .A1(weight[8]), .A2(\in4[8] ), .B1(n495), .B2(n461), .ZN(
        n309) );
